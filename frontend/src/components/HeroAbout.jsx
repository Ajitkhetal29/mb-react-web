...
const HeroAbout = () => {
  ...
  {/* Content Container */}
  <div
    className="relative z-10 container mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 px-6 md:px-12 lg:px-16"
  >
    {/* Text Section */}
    <div
      className="text-white max-w-xl text-center lg:text-left space-y-4 fade-in-left"
    >
    ...
    {/* Video Section */}
    <div
      className="fade-in-right w-full h-full max-w-xl aspect-video rounded-2xl overflow-hidden shadow-2xl border border-white/10 backdrop-blur-sm"
    >
      <iframe
