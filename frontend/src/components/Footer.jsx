      ...
      <div className="mt-10 flex  flex-col lg:flex-row gap-10 lg:gap-0 items-start lg:items-center border-t border-gray-200 pt-10">
        ...
        <div className="lg:w-1/2 px-4 flex flex-col items-center">
          ...
          <form className="w-full max-w-md">
            ...
            <div className="flex  flex-row  items-center gap-3 border border-gray-300 rounded p-2">
              <input
                type="email"
                id="UserEmail"
                placeholder="john@rhcp.com"
                className="w-full border-none focus:outline-none sm:text-sm text-gray-700"
              />
              <button
                type="submit"
                className="w-full sm:w-auto bg-black text-white rounded px-6 py-3 text-sm tracking-wide hover:bg-gray-900 transition-colors"
              >
                Subscribe
              </button>
            </div>
